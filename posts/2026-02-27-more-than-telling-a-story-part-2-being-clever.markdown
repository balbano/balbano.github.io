---
title: "More than telling a story part 2 - Being Clever"
tags: games
---
...
A common mode of play in OSR-style games is when the GM describes an obstacle to the players, and does not have any particular solution in mind (or is at least open to being surprised), then the players proceed to ask questions about their environment, look at the list of bizarre shit they've accumulated in their inventories, and then pitch the GM a solution combining various objects and elements of their fictional environment. The GM then becomes an adjudicator of cleverness.
...
This back and forth between players and GM negotiating the problem-without-a-solution is an example of playing with cleverness.

### Problems with solutions

The problems without solutions style of play is itself a sort of solution to the stumbles that are easy to make when playing TTRPGS with more structured puzzles. It can be frustrating to feel stonewalled by a puzzle with a solution that you just can't find. Feeling like you're not clever enough isn't all that fun! But in spite of the risks, I've recently become curious about this more traditional puzzle solving where you *do* have solutions. I'm looking forward to running some escape-room-style puzzle dungeons, and reading [Direct Sun's puzzle dungeon posts](https://puzzledungeon.com/). Done well, this is another exciting way to play towards the joy of being clever.

### Word play

In some games, trying to bend your skills, tags, etc., to always apply to the challenge at hand can feel against the spirit of the game, but when it fits the tone, or isn't overdone, it can be a lot of fun!

In my game [Word Wizards](https://ponypress.itch.io/word-wizards), the central mechanic revolves around knowing a very limited number of words of power, and then bending them to solve any problem your character faces. I remember during a playtest, one character had the word of power "cow" and, faced with a terrifying situation, declared "I'm no COWard" to use their magic to give them bravery. That's exactly the sort of "being clever" that is the core gameplay of Word Wizards, and is another version of the play of cleverness.
